...
import Obfuscator, { RevealMode } from "../utils/TextScrambler/obfuscator";
import { baffleReducer, initialState } from "../utils/TextScrambler/reducer";
import { getTruthyIndices } from "../utils/TextScrambler/utils";
import { DEFAULT_SCRAMBLE_SPEED, SYMBOLS } from "../utils/variables";
...
export const useTextScramble = (
  ...
  const config = useMemo<TextScrambleConfig>(
